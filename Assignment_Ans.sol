...
contract Ballot {
    ...
    struct Voter {
        ...
        uint vote;   // index of the voted proposa
    ...
    function giveRightToVote(address [] calldata _votersAddresses) external {
        ...
        for (uint i = 0; i < _votersAddresses.length; i++) {
            ...
            require(
            !_voter.voted, // i created a for loop that accept more than 10 voters at a time as this is the situation in the real use case
